...
<body>
                ...
                <div class="col s12 m6 offset-m3">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <form id="reset-form" action="../PHP/actualizar_contrasena.php" method="post">
                                ...
                                <div class="input-field">
                                    <button class="btn blue" type="submit" style="width: 100%;">Restablecer
                                        Contraseña</button>
                                </div>
                            </form>
                        </div>
    ...
    <footer class="border-top footer text-muted">
        <div class="container">
            &copy; 2024 - TuSalud - <a href="/Home/Privacy">Privacy</a>
        </div>
    </footer>
